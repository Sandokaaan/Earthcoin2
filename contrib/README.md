...
Contains files used to package earthcoind/earthcoin-qt
...
### [RPM](/contrib/rpm) ###
RPM spec file for building earthcoin-core on RPM based distributions
...
This script attempts to download and verify the signature file SHA256SUMS.asc from earthcoin.com.
