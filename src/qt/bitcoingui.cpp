    ...
    platformStyle(_platformStyle)
{
    ...
    // Earthcoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // Earthcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Earthcoin: Set new application font
