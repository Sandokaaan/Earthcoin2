...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s earthcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  earthcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded earthcoin transaction") + "\n" +
              "  earthcoin-tx [options] -create [commands]   " + _("Create hex-encoded earthcoin transaction") + "\n" +
              "\n";
