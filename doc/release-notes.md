Earthcoin Core version 1.14.2 is now available from:

  <https://github.com/earthcoin/earthcoin/releases/tag/v1.14.0/>
...
To receive security and update notifications, please watch reddit or Twitter:
  ...
  * https://www.reddit.com/r/earthcoin/
  * @Earthcoin on Twitter for high priority announcements
  * @earthcoin\_devs on Twitter for updates on development work
...
Earthcoin Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Earthcoin Core introduces pruning the blockchain in 1.14. Pruning
...
Since 1.14.0 the approximate transaction fee shown in Earthcoin-Qt when using coin
